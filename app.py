...
def create_app(test_config=None):
    ...
    def add_Flight():
        try:
            ...
            flight = Flight(SpaceShip = data['spaceship'],Station=data['station'],LaunchingPad=data['launchingpad'],LaunchingDate=data['launchingdate'])
    ...
    def add_vehicle():
        try:
            ...
            if(data['reuseable'] == 'True'):
                reuseable = True
            Spaceship = SpaceShip(name = data['name'],model=data['model'],reuseable=reuseable,capacity=data['capacity'])
    ...
    def add_Astronaut():
        try:
            data = json.loads(request.data)
            print(data)
            astronaut = Astronaut(name = data['name'],Job=data['job'],Flight=data['flight'])
    ...
    def add_Station():
        try:
            data = json.loads(request.data)
            print(data)
            station = Station(CrewCapacity = data['crewcapacity'],FuelCapacity=data['fuelcapacity'])
